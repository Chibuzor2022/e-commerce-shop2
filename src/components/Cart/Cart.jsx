...
const Cart = ({cart, handleUpdateCartQty, handleRemoveFromCart, handleEmptyCart}) => {
  ...
  const EmptyCart = () => (
    <Typography variant="subtitle1">You have nothing in your Shopping Cart,
      <Link to="/" className={classes.link}> Please add items</Link>!
    </Typography>
  );
  ...
  const FilledCart = () => (
    <>
      ...
      <div className={classes.cardDetails}>
        ...
        <Button component={Link} to ="/checkout" size="small" className={classes.checkoutButton} type="button" variant="contained" color="primary">Checkout</Button>
        </div>
    </>
  )
